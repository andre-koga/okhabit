...
export const dialogFieldClassName =
  "w-full rounded-md border bg-background px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary disabled:cursor-not-allowed disabled:opacity-50";

export const dialogTextareaClassName = `${dialogFieldClassName} resize-none`;

export const dialogSelectTriggerClassName =
  "h-10 w-full rounded-md border bg-background px-3 text-sm focus-visible:border-primary focus-visible:ring-2 focus-visible:ring-primary";
